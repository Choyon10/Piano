...
public class Soctave extends JFrame {
			...
			public boolean dispatchKeyEvent(KeyEvent e) {
				...
				if(e.getID() == KeyEvent.KEY_PRESSED)
				{
					...
					if(e.getKeyChar() == 'z')
						playSound("Cm lowest");
					if(e.getKeyChar() == 's')
						playSound("C#m lowest");
					
					if(e.getKeyChar() == 'x')
						playSound("Dm lowest");
					if(e.getKeyChar() == 'd')
						playSound("D#m lowest");
					...
					if(e.getKeyChar() == 'v')
						playSound("Fm lowest");
					if(e.getKeyChar() == 'g')
						playSound("F#m lowest");
					
					if(e.getKeyChar() == 'b')
						playSound("Gm lowest");
					if(e.getKeyChar() == 'h')
						playSound("G#m lowest");
					
					if(e.getKeyChar() == 'n')
						playSound("Am lowest");
					if(e.getKeyChar() == 'j')
						playSound("A#m lowest");
					if(e.getKeyChar() == 'm')
						playSound("Bm lowest");
